public class Livro {
    ...
    String introducao = ("\nBem-vindo ao incrível mundo interativo de -O Despertar do Aventureiro:\n"
            ...
            + "(VOCÊ INICIA COM UMA PONTUAÇÃO DE 1000 XP DE ENERGIA)\n"
            + "\n" + this.menu());

    public String menu() {
        return "Qual caminho você escolhe para começar sua busca?\n"
                + "a) Atravessar a densa Floresta Proibida.\n"
                + "b) Seguir a trilha das Montanhas da Perdição.";
    }

    String florestaP = ("\nCapítulo: Desafios na Floresta Proibida\n"
            + "Você decide aventurar-se pela Floresta Proibida, um local sombrio e\n"
            ...
            + "a) Corre o máximo que puder.\n"
            + "b) Luta com o dragão, mesmo sabendo que pode ou não perder suas energias.\n");

    String montanhaP = ("\nCapítulo: Nas Montanhas da Perdição\n"
            + "Você opta por enfrentar os desafios das Montanhas da Perdição, um local\n"
            ...
            + "a) Tomar a poção.\n"
            + "b) Recusar e agradecer o mago.\n");

    String troll = ("\nSeu coração bate acelerado enquanto você segue o caminho iluminado pelo\n"
            ...
            + "a) Lutar contra Grunthor, usando todas as suas habilidades de combate.\n"
            + "b) Tentar escapar furtivamente, desviando-se silenciosamente e continuando\n"
            + "seu percurso.\n");

    String dragao20C = ("\nCapítulo: O dragão de 20 cabeças\n"
            + "Você segue com o seu mapa subindo pela Montanha da Sucuri. Ao chegar no topo\n"
            + "encontra um dragão de 20 cabeças.\n"
            + "\n"
            + "Assustado o que você vai fazer?\n"
            + "a) Matar o feroz dragão.\n"
            + "b) Correr da situação\n");

    String fada = ("\nCapítulo: A fada vermelha\n"
            + "Você dorme depois de um dia agitado. Mas ao acordar percebe que não está só.\n"
            ...
            + "a) Recusar proposta da fada e expulsar ela.\n"
            + "b) Aceitar a fada.\n");

    String mostroP = ("\nCapítulo: O pântano obscuro\n"
            + "Sua jornada continua, e dessa vez você quase cai dentro de um pântano. Ao\n"
            ...
            + "a) Lutar contra esse mostro e ter a possibilidade e melhorar suas energias.\n"
            + "b) Não se arriscar\n");
